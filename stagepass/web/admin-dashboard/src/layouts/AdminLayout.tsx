...
> = [
  ...
  { type: 'link', to: '/holidays', label: 'Holidays', icon: TimeOffIcon },
  ...
  { type: 'link', to: '/checkins', label: 'Daily office check-ins', icon: CheckinsIcon },
...
const pathToTitle: Record<string, string> = {
  ...
  '/clients': 'Clients',
  '/reports': 'Reports',
  '/checkins': 'Daily office check-ins',
